						...
						<div id="login" class="wpml-content">
							...
							<form action="login" method="post" id="form" class="group" name="loginform">
								...
								<p>
									...
									<input type="text" name="log" id="login_user" class="input form-control" value="<?php if ( isset( $user_login ) ) echo esc_attr( $user_login ); ?>" size="20" />
								</p>

								<p>
									<label class="field-titles" for="login_pass"><?php _e( 'Password', 'geissinger-wpml' ); ?></label>
									<input type="password" name="pwd" id="login_pass" class="input form-control" value="" size="20" />
								</p>
								...
								<div id="register" class="wpml-content" style="display:none;">
									...
									<form action="register" method="post" id="form" class="group" name="loginform">
										...
										<p>
											...
											<input type="text" name="user_login" id="reg_user" class="input form-control" value="<?php if ( isset( $user_login ) ) echo esc_attr( stripslashes( $user_login ) ); ?>" size="20" />
										</p>

										<p>
											<label class="field-titles" for="reg_email"><?php _e( 'Email', 'geissinger-wpml' ); ?></label>
											<input type="text" name="user_email" id="reg_email" class="input form-control" value="<?php if ( isset( $user_email ) ) echo esc_attr( stripslashes( $user_email ) ); ?>" size="20" />
										</p>
						...
						<div id="forgotten" class="wpml-content" style="display:none;">
							...
							<form action="forgotten" method="post" id="form" class="group" name="loginform">
								...
								<p>
									...
									<input type="text" name="forgot_login" id="forgot_login" class="input form-control" value="<?php if ( isset( $user_login ) ) echo esc_attr( stripslashes( $user_login ) ); ?>" size="20" />
								</p>
